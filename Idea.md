...
- Core - pure logic changing given string into qr-code - represents core business logic
- Infrastructure - adapters to connect our `Core` to different clients - represents adapters
- Clients - our CLI and GUI logic - represents front-end it call infrastructure
...
### External
This app is using https://linux.die.net/man/1/qrencode under the hood.
